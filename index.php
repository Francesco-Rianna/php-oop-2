...
// var_dump($dogBed);
$omegaSpray = new CatProduct('Omega','spray per il pelo del gatto', 19, 'gatti','pelo lungo','https://shop-cdn-m.mediazs.com/bilder/0/400/435002_pla_felisept_fellpflege_faltschachtel_flasche_hs_01_0.jpg');
// var_dump($omegaSpray);
...
<body>
    <div>
        <!-- <?php echo $bosch->getProduct(); ?> -->
    </div>

    <div>
        <!-- <?php echo $dogBed->kennels ; ?> -->
    </div>
</body>
</html>